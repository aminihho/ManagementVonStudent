...
public class IndexUpdatePersonController implements MouseListener, KeyListener, ActionListener, PopupMenuListener {
    ...
    /**
     * *******************************************************************************
     * Alle Aktivitaten einer Person werden durch Click auf die Tabelle
     * eingeblendet
     ********************************************************************************
     */
        ...
        if (source instanceof JButton) {
            ...
            if (source == view.printBtn) {
                ...
                if (this.anzahl_Studnets == 1) {
                    ...
                    try {
                        JSONObject studenten = this.getAlleInofrmorationAllerUser(query);
                        this.CreateExcelDatei(studenten);
    ...
    private void CreateExcelDatei(JSONObject students_info ) throws JSONException{
        ExcelModel excelModel = new ExcelModel(students_info);
        excelModel.setQueryInfo(model.getQueryInfo());
        ExcelView excelView = new ExcelView(excelModel, "ExcelDatei"); 
    ...
    public JSONObject getAlleInofrmorationAllerUser(String query) throws JSONException {
        ...
        jsonObject.put("studenten", array);
        return jsonObject;
    }
