 ...
 */
public class InsertStatusModelKlein extends Observable {

    Connection conn = null;
    PreparedStatement pst = null;
    ResultSet result = null;
    String fehlerString = null;

    /**
     * Konstruktor der Klasse
     */
    public InsertStatusModelKlein(){
    ...
    public  boolean insertStatus(String nameStatus){
        try{
            // Query
