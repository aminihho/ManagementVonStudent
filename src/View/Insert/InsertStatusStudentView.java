...
public class InsertStatusStudentView extends JFrame implements Observer {
    ...
    public JPanel makeJpanel() {
        ...
        controlPanel.setBounds(145, 79, 484, 340);
        ...
        studentCb.setBounds(150, 40, 310, 27);
        controlPanel.add(studentCb);

        statusCb = new JComboBox(dataStatusArray);
        statusCb.addActionListener(_controller);
        statusCb.setBounds(150, 151, 310, 27);
        statusCb.addKeyListener(_controller);
        statusCb.setFont(new Font("Sans Serif", Font.PLAIN, 13));
        controlPanel.add(statusCb);

        status1Cb = new JComboBox(dataStatusArray);
        status1Cb.addActionListener(_controller);
        status1Cb.addKeyListener(_controller);
        status1Cb.setBounds(150, 253, 310, 27);
        status1Cb.setFont(new Font("Sans Serif", Font.PLAIN, 13));
        ...
        sendenBtn.setBounds(371, 435, 42, 40);
        ...
        zurueckBtn.setBounds(680, 372, 49, 49);
        ...
        neuerStudentbtn.setBounds(422, 79, 38, 38);
        ...
        neuerStatusBtn.setBounds(422, 190, 38, 38);
        neuerStatusBtn.setBorder(loweredetched);
        neuerStatusBtn.setToolTipText("Neuer Status eintragen");
    ...
    public void initView(){
        // Clear Combo Boxes
        this.studentCb.setSelectedItem(_model.defaultObject);
