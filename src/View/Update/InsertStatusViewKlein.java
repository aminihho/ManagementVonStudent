...
import Controller.Update.InsertStatusControllerKlein;
 ...
 */
public class InsertStatusViewKlein extends JFrame implements Observer {

    // Model.
    private InsertStatusModelKlein model;
    // Controller.
    private InsertStatusControllerKlein controller;
    ...
    public InsertStatusViewKlein(InsertStatusModelKlein _model, String name) {
        setTitle(name);
        model = _model;
        model.addObserver(this);
        //Controller
        controller = new InsertStatusControllerKlein(this.model, this);
    ...
    private JPanel make_contentPanel() {
         ...
         * Labels
         */
        statusLbl = new JLabel("Name:");
        statusLbl.setFont(new Font("Sans Serif", Font.PLAIN, 15));
        statusLbl.setBounds(40, 60, 123, 15);
        panel.add(statusLbl);
        ...
        statusTxtFld.setBounds(177, 56, 325, 27);
