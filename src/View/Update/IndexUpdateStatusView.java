...
public class IndexUpdateStatusView extends JFrame implements Observer {
    ...
    public IndexUpdateStatusView(IndexUpdateStatusModel _model, String _titel)
    {
        model=_model;
        model.addObserver(this);
        controller = new IndexUpdateStatusController(this.model, this);
    ...
    private JPanel  make_contentPanel(){
         ...
         * Labels
         */
        JLabel infoLabel = new JLabel("Status ändern oder löschen");
        ...
        neuBtn.setToolTipText("Neuer Status eintragen");
        ...
        loschenBtn.setToolTipText("Status löschen");
        ...
        updateBtn.setToolTipText("Status ändern");
        ...
        zurueckBtn.setBounds(692, 428, 49, 50);
        ...
        String[][] dataAktivitat = useFunction.arrayListTo2DArrayVonString(this.model.returnAllStatusArrayList());
        ...
        statusTabelle = new JTable(defultModelAktivitat);

        statusTabelle.addMouseListener(controller);

        //Button_intialisieren_Table();
        defultModelAktivitat.setDataVector(dataAktivitat,titleStatus);

        JScrollPane sPaneStatus=new JScrollPane(statusTabelle);
